...
type BacktestMarket = "NYSE" | "NASDAQ" | "AMEX" | "CBOE" | "CME";
...
const KNOWN_MARKETS: BacktestMarket[] = ["NYSE", "NASDAQ", "AMEX", "CBOE", "CME"];
...
export function BacktestingPage() {
  ...
  const [market, setMarket] = useState<BacktestMarket>((selectedMarket as BacktestMarket) || "NASDAQ");
  ...
  useEffect(() => {
    ...
    if (KNOWN_MARKETS.includes(filters.market as BacktestMarket)) setMarket(filters.market as BacktestMarket);
